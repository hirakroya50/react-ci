...
const features = [
  ...
  { icon: '🎨', title: 'Beautiful Design', desc: 'Pixel-perfect components with a cohesive design language built for modern products.' },
  { icon: '🔒', title: 'Secure by Default', desc: 'Enterprise-grade security baked in from day one. Your data is always protected.' },
  { icon: '📱', title: 'Fully Responsive', desc: 'Seamless experience across every device — desktop, tablet, and mobile.' },
  { icon: '🔌', title: 'Easy Integration', desc: 'Connect to any third-party service with our plug-and-play integration system.' },
  { icon: '📊', title: 'Real-time Analytics', desc: 'Monitor your metrics live with powerful dashboards and actionable insights.' },
]
...
const testimonials = [
  { name: 'Sarah Chen', role: 'CTO at NovaTech', avatar: 'SC', text: 'Switching to this platform cut our deployment time by 60%. The DX is genuinely exceptional.' },
  { name: 'Marcus Rivera', role: 'Lead Engineer at Flux', avatar: 'MR', text: 'The best developer experience I have had in years. Clean APIs and zero config headaches.' },
  { name: 'Aisha Patel', role: 'Product Manager at Orbit', avatar: 'AP', text: 'Our team was up and running in under an hour. The onboarding is ridiculously smooth.' },
]
    ...
    <div className="app">
      ...
      <section className="cta-section">
        <div className="cta-inner">
          ...
          <Link to="/login" className="btn btn-white btn-lg">Create free account →</Link>
        </div>
      </section>
