...
const Dashboard = () => {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-(--bg)! pb-16! pt-20! md:pt-[6rem]!">
      ...
      <div className="relative mx-auto flex flex-col gap-7! px-4! sm:px-6! lg:px-8!">
        ...
        <section className="rounded-[2rem]! border! border-[var(--border)]! bg-(--surface-glass)! p-6! shadow-[var(--shadow-sm)]! backdrop-blur-xl! md:p-8!">
          <div className="mb-6 flex flex-col gap-2! sm:flex-row sm:items-end sm:justify-between">
            ...
            <div className="text-[11px] my-3! font-black uppercase tracking-[0.2em] text-(--text-muted)">
              Composer
            </div>
          </div>
